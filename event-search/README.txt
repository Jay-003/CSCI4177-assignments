...
* *Group Github branch URL*: <https://github.com/Jay-003/CSCI4177>

* *Group GitLab URL*: <https://git.cs.dal.ca/sicheng/csci-4177-group19>
* *Group GitLab branch URL*: <https://git.cs.dal.ca/jmodi/csci-4177-tutorials>

## Authors

* [Jay Modi](jay.modi@dal.ca) - Developer
